<?php
    ...
    if ( is_category() ) {
        $tax = "Category";
        $criterio = single_cat_title('', false); //
    } elseif ( is_tag() ) {
        $tax = "Tag";
        $criterio = single_tag_title('', false);
    } elseif ( is_author() ) {
        $tax = "Author";
        $criterio = get_the_author();
    }  elseif ( is_day() ) {
        $tax = "Day";
        $criterio = get_the_date();
    } elseif ( is_moth() ) {
        $tax = "Month";
        $criterio = get_the_date('F Y');
    } elseif ( is_year() ) {
        $tax = "Year";
        $criterio = get_the_date('Y');
    }
